          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div className="container trends-slide-inner">
                ...
                <Link href={slide.href} className="trends-slide-button">
                  {slide.cta}
                </Link>
              </div>
            </article>
      ...
      <div className="container trends-insights-grid">
        <div className="trends-insights-copy">
          ...
          <p>
            ...
            projects. It is through knowledge sharing&mdash;powered by strong relationships,
            industry-leading data and innovative technology&mdash;that we empower our clients to
            reimagine how business gets done. When companies want knowledge, leadership and
            flexibility, they look to Kforce. <strong>Together, let&apos;s do great things.</strong>
          </p>
        </div>
